...
- Name: auth.spec.ts >> Protected Routes >> redirects /activities to login when unauthenticated
- Location: e2e/auth.spec.ts:72:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/activities
Call log:
  - navigating to "http://localhost:3000/activities", waiting until "load"
