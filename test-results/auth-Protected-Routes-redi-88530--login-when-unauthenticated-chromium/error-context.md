...
- Name: auth.spec.ts >> Protected Routes >> redirects /responsibilities to login when unauthenticated
- Location: e2e/auth.spec.ts:72:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/responsibilities
Call log:
  - navigating to "http://localhost:3000/responsibilities", waiting until "load"
