      ...
      <div className="w-full max-w-[440px]">
        ...
        <div className="rounded-[20px] border border-line bg-card p-8 shadow-[0_20px_50px_rgba(13,29,26,0.08)]">
          ...
          <p className="mt-5 text-center text-[13px] text-ink-soft">
            <Link
              href="/login"
              className="font-bold text-aztec underline-offset-2 hover:underline focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-saffron"
            >
              Back to sign in
            </Link>
          </p>
